...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { data: @venda.data, nome_comprador: @venda.nome_comprador, receita: @venda.receita } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { data: @venda.data, nome_comprador: @venda.nome_comprador, receita: @venda.receita } }
